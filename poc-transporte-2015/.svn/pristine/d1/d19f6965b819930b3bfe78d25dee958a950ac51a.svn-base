...
from SetwiseOperations import get_redis_id
...
class Crawl:
    ...
    def crawl_friends(self, t, r, friends_ids, limit=1000000, depth=2):
        # Helper function
    ...
    def get_all_friends_ids(self, user_id, limit=1000000):
        cursor = -1
        ids = []
        while cursor != 0:
    ...
    def crawl_followers(self, t, r, follower_ids, limit=1000000, depth=2):
    ...
    def get_all_followers_ids(self, user_id, limit=1000000):
